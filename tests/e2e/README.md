...
- `specs/deploy-log.spec.js` — newest-tail HTML, cursor-stable older pages, bounded live drain through an atomic terminal line, complete retained NDJSON, session/permission stops and bounded single-flight retry after a network fault.
