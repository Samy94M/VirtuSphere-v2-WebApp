...
- [Installation mit Netzzugang](docs/INSTALLATION-ANLEITUNG.md); für einen luftspaltgetrennten Produktionshost stattdessen [Offline-Installation](docs/operations/offline-install.md). Die zulässigen Update-/Rückkehrkombinationen und das Wartungsfenster stehen in [Upgrade und Recovery](docs/operations/upgrade-recovery.md).
...
- [ESXi-Inventar](docs/operations/esxi-inventory.md), [automatischer Ansible-Volltest](docs/operations/ansible-full-test.md), [MECM-Integration](docs/operations/mecm-integration.md), [Active Directory über LDAPS](docs/operations/active-directory.md), [VM-Fortschrittsbeobachtung](docs/operations/vm-progress-observation.md), [HTTPS](docs/operations/https.md), [Laufzeitprotokolle](docs/operations/logging.md) und [Backup/Restore](docs/operations/backup.md).
