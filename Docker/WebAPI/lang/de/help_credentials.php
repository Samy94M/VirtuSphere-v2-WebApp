...
return [
    ...
    'credentials_tests_p1' => 'Der manuelle Ansible-Volltest läuft sofort. Sein Ergebnis gilt nur für die unveränderte Zugangskonfiguration und die neueste Testgeneration; eine parallele Änderung oder ein neuerer Test verwirft einen später eintreffenden Altstand. Die Rückmeldung und das Protokoll kennzeichnen ein verworfenes Ergebnis als Warnung; es ersetzt keinen gültigen Nachweis. Sein letzter gültiger Status und Zeitpunkt bleiben im Systemstatus sichtbar; er wird nach dem konfigurierten Intervall automatisch wiederholt, sofern die Automatik aktiv und der Dienst verfügbar ist. Nach :days Tagen ohne Test steht die Ampel auf „Test veraltet": Das ist kein gemeldeter Fehler, sondern fehlender aktueller Nachweis. Der letzte vom Worker bearbeitete Missionsauftrag steht getrennt daneben und erneuert den Volltest nicht.',
