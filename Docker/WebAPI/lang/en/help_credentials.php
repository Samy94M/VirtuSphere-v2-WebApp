...
return [
    ...
    'credentials_tests_p1' => 'The manual Ansible full test runs immediately. Its result is valid only for the unchanged credential configuration and newest test generation; a concurrent edit or newer test discards an older result that finishes later. The feedback and audit mark a discarded result as a warning; it does not replace valid evidence. Its latest valid status and timestamp remain visible in System status; it repeats according to the configured interval when automation is enabled and the service is available. After :days days without a test the traffic light reads "Test outdated": this is not a reported failure, but missing current evidence. The last mission job the worker processed is shown separately and does not refresh the full test.',
