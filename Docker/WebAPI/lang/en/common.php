...
return [
    ...
    'conn_ansible_sftp' => 'The SSH login to the Ansible host succeeded, but the file transfer failed.',
    ...
    'conn_ssh' => 'Legacy value from earlier pulls: fresh pulls no longer write it. A new pull replaces the result with a category that names the Ansible host or the ESXi host.',
