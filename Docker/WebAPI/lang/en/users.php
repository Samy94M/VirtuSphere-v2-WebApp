...
return [
    'title' => 'Users',
    'tabs_label' => 'User sections',
    'create_heading' => 'Create user',
    'create_local_hint' => 'Accounts created here are local emergency or operational accounts. Active Directory accounts are imported through directory search.',
    'field_email' => 'Email',
    ...
    'err_last_local_admin' => 'The last active local administrator cannot be deactivated or demoted.',
    'err_local_action_only' => 'This action is available only for a local account.',
    'err_user_missing' => 'The user account was not found.',
