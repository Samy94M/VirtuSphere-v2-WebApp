...
// Order mirrors the settings.php tab grouping: Bereitstellung, Machine-API,
// Kataloge und Inventar, HTTPS, System.
...
?>
    <div class="stack" id="panel-settings" role="tabpanel" aria-labelledby="tab-settings" tabindex="0" data-tab-panel>
        ...
        <section class="panel">
            <h2><?php echo h(__t('help.settings_probe_heading')); ?></h2>
        ...
        <section class="panel">
            <h2><?php echo h(__t('help.settings_retire_heading')); ?></h2>
        ...
        <section class="panel">
            <h2><?php echo h(__t('help.settings_esxi_heading')); ?></h2>
        ...
        <section class="panel">
            <h2><?php echo h(__t('help.settings_https_heading')); ?></h2>
        ...
        <section class="panel">
            <h2><?php echo h(__t('help.settings_time_heading')); ?></h2>
            <p><?php echo h(__t('help.settings_time_p1')); ?></p>
            <p><?php echo h(__t('help.settings_time_p2')); ?></p>
        </section>

        <section class="panel">
            <h2><?php echo h(__t('help.settings_session_heading')); ?></h2>
        ...
        <section class="panel">
            <h2><?php echo h(__t('help.settings_password_heading')); ?></h2>
        ...
        <section class="panel">
            <h2><?php echo h(__t('help.settings_backup_heading')); ?></h2>
