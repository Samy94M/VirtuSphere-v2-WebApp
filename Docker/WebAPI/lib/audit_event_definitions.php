...
function audit_event_registry(): array
{
    ...
    return [
        ...
        VIRTUSPHERE_AUDIT_EVENT_CREDENTIAL_TESTED => audit_definition(VIRTUSPHERE_LOG_CATEGORY_CREDENTIALS, ['credential'], [VIRTUSPHERE_AUDIT_RESULT_SUCCESS, VIRTUSPHERE_AUDIT_RESULT_WARNING, VIRTUSPHERE_AUDIT_RESULT_FAILURE], ['outcome', 'evidence_stored'], ['component', 'ip']),
