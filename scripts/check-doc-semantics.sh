...
# Compose referenziert das lokal gehaertete MySQL-Child-Image ueber einen festen
# Tag, der docker save/load ueberlebt; dessen Dockerfile pinnt die Upstream-Basis
# per Digest. Die sichtbare Produktlinie bleibt Teil des Tags. Das Muster matcht
# `mysql:` deshalb an beliebiger Stelle der image-Zeile; der Zero-Match-Zweig
# unten bleibt ein echter Befund.
