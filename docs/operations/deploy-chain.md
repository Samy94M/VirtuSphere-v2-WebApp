...
Der Abschlusszustand und seine letzte SYSTEM-Zeile werden in derselben Datenbanktransaktion geschrieben. Ein normaler Schreiber sperrt zuvor den Auftrag und lehnt jede weitere Zeile nach einem terminalen Zustand ab. Damit kann weder ein Poller eine noch nicht sichtbare Abschlusszeile übersehen noch ein später Callback einen bereits abgeschlossenen Verlauf verlängern.
